...
class CreateBenchmarkTicketRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["benchmarkId", "agentId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["benchmarkId", "agentId", ], str]):
