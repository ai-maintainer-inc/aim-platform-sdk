...
# body param
SchemaForRequestBodyApplicationJson = ManageUserBidRequest


request_body_manage_user_bid_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Bid
...
class BaseApi(api_client.Api):
    ...
    def _manage_user_bid_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_manage_user_bid_request.serialize(body, content_type)
...
class ManageUserBid(BaseApi):
    ...
    def manage_user_bid(
        ...
        return self._manage_user_bid_oapg(
            body=body,
