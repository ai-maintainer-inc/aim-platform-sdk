...
# body param
SchemaForRequestBodyApplicationJson = CreateAgentRequest


request_body_create_agent_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Agent
...
class BaseApi(api_client.Api):
    ...
    def _create_agent_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_agent_request.serialize(body, content_type)
