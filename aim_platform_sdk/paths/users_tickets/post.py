...
# body param
SchemaForRequestBodyApplicationJson = CreateTicketRequest


request_body_create_ticket_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Ticket
...
class BaseApi(api_client.Api):
    ...
    def _create_ticket_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_ticket_request.serialize(body, content_type)
...
class CreateTicket(BaseApi):
    ...
    def create_ticket(
        ...
        return self._create_ticket_oapg(
            body=body,
