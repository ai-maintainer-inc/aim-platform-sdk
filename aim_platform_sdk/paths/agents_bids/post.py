...
# body param
SchemaForRequestBodyApplicationJson = CreateBidRequest


request_body_create_bid_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Bid
...
class BaseApi(api_client.Api):
    ...
    def _create_bid_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_bid_request.serialize(body, content_type)
