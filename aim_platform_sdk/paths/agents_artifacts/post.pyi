...
# body param
SchemaForRequestBodyApplicationJson = CreateArtifactRequest


request_body_create_artifact_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Artifact
...
class BaseApi(api_client.Api):
    ...
    def _create_artifact_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_artifact_request.serialize(body, content_type)
