...
class ErrorsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ErrorsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ErrorsResponse:
        """Create an instance of ErrorsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ErrorsResponse.parse_obj(obj)

        _obj = ErrorsResponse.parse_obj({
