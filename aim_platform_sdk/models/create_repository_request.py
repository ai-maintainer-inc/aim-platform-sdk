...
class CreateRepositoryRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRepositoryRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRepositoryRequest:
        """Create an instance of CreateRepositoryRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateRepositoryRequest.parse_obj(obj)

        _obj = CreateRepositoryRequest.parse_obj({
