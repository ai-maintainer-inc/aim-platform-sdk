...
class AgentsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AgentsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AgentsResponse:
        """Create an instance of AgentsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AgentsResponse.parse_obj(obj)

        _obj = AgentsResponse.parse_obj({
